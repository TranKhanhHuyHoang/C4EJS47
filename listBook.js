let list = [{
    srcImg: 'Suc Manh Cua Ngon Từ.jpg',
    name: 'Sức mạnh của ngôn từ',
    price: 84000,
    amount: 1,
    ...
    page: 310,
    year: 2009,
    description: 'Sức Mạnh Của Ngôn Từ (Tái Bản 2016) Sử dụng đúng ngôn từ để đạt hiệu quả giao tiếp cao nhất.. Nếu bạn cũng giống như hàng triệu người thường ngồi lặng yên trong các cuộc họp, bỏ lỡ nhiều cơ hội thăng tiến, căng thẳng trong các buổi gặp mặt, không biết nói gì mỗi khi đối diện với cấp trên, thường nói với người thân những điều khiến sau này phải hối hận, hoặc không bao giờ đạt được ...',
    subDescription: `Sức Mạnh Của Ngôn Từ (Tái Bản 2016)
...
{
    scrImg: 'Bản đồ tư duy.jpg',
    name:'Bản đồ tư duy trong thuyết trình',
    price: 69000,
    amount: 1,
    NXB: 'NXB dân trí',
    author: 'Alpha book',
...
},
{
    ...
    page: 235,
    year: 2010,
    description: 'Sự ảnh hưởng của khoa học và công nghệ đối với đời sống của con người nói chung cũng trở thành một xu hướng tất yếu không thể đảo ngược được. Do vậy, ngoài những kiến thức và kỹ năng cơ bản trong đời sống xã hội, chúng ta còn phải giúp cho các học sinh có được những năng lực mang tính chất nền tảng liên ngành về STEM (Science, Technology, Engineering, Mathematics: Khoa học, Công nghệ, ...',
    subDescription: `Sự ảnh hưởng của khoa học và công nghệ đối với đời sống của con người nói chung cũng trở thành một xu hướng tất yếu không thể đảo ngược được. Do vậy, ngoài những kiến thức và kỹ năng cơ bản trong đời sống xã hội, chúng ta còn phải giúp cho các học sinh có được những năng lực mang tính chất nền tảng liên ngành về STEM (Science, Technology, Engineering, Mathematics: Khoa học, Công nghệ, Kỹ thuật và Toán học) để có thể trở thành những công dân toàn cầu thích ứng trong thế giới tương lai. 
...
{
    scrImg: 'Đọc vị bất kỳ ai.jpg',
    name:'Đọc vị bất kỳ ai',
    price: 69000,
    amount: 1,
    NXB: 'Đại học Kinh Tế Quốc Dân',
    author: 'David J Lieberman',
    isSale: 20,
    page: 225,
    year: 2018,
    description: 'Đọc Vị Bất Kỳ Ai - Để Không Bị Lừa Dối Và Lợi Dụng (Tái Bản 2018). Bạn băn khoăn không biết người ngồi đối diện đang nghĩ gì? Họ có đang nói dối bạn không? Đối tác đang ngồi đối diện với bạn trên bàn đàm phán đang nghĩ gì và nói gì tiếp theo?. ĐỌC người khác là một trong những công cụ quan trọng, có giá trị nhất, giúp ích cho bạn trong ...',
    subDescription: `Đọc Vị Bất Kỳ Ai - Để Không Bị Lừa Dối Và Lợi Dụng (Tái Bản 2018)
...
{
    scrImg: 'Chó Sửa Nhầm Tree.jpg',
    ...
    page: 320,
    year: 2019,
    description: 'Bạn có biết:. - Các thủ khoa hiếm khi trở thành triệu phú, và nhược điểm lớn nhất có khi lại là ưu điểm tuyệt vời nhất mà ai ai cũng khao khát sở hữu.. - Ở công ty, sự chăm chỉ đang bị thổi phồng quá mức, còn những trò nịnh bợ lại thường mang đến kết quả tốt, và liệu đề cao chính nghĩa hay sa vào tà đạo mới là con đường dẫn đến thành công?. - Những ...',
    subDescription: `Bạn có biết:
...
{
    scrImg: 'PQ chỉ số đam mê.jpg',
    name:'PQ chỉ số đam mê',
    price: 90000,
    amount: 1,
    ...
    page: 312,
    year: 2017,
    description: 'PQ Chỉ Số Đam Mê   “Chỉ số đam mê” là một thuật ngữ mới mà tác giả Virender Kapoor đã sáng tạo ra như là một cách nói mới về những gì chúng ta hay dùng để chỉ nhiệt huyết hay ngọn lửa trong lòng. Niềm đam mê của bạn là gì, bạn nhận biết như thế nào về những thứ mình thích và không thích, bạn đã biết cách sử dụng niềm đam mê ...',
    subDescription: `PQ Chỉ Số Đam Mê
 
    “Chỉ số đam mê” là một thuật ngữ mới mà tác giả Virender Kapoor đã sáng tạo ra như là một cách nói mới về những gì chúng ta hay dùng để chỉ nhiệt huyết hay ngọn lửa trong lòng. Niềm đam mê của bạn là gì, bạn nhận biết như thế nào về những thứ mình thích và không thích, bạn đã biết cách sử dụng niềm đam mê của mình như những người thành công chưa? Đây là những điều cuốn sách sẽ dạy bạn.
     
    Cuốn sách này sẽ khơi gợi, chỉ dẫn và mang lại những điều mới mẻ cho cuộc sống, công việc, gia đình và cả thái độ của bạn! Có những xúc cảm tiêu cực không chỉ lấy đi niềm vui, năng lượng của bạn mà còn quấy quả bạn không ngớt. Bạn không chỉ cần có thái độ tích cực – như những gì mọi người vẫn thường nói – mà còn cần “thắp sáng” cho thái độ sống của mình.
     
    Nếu cuốn sách này có thể giúp tăng chỉ số đam mê của bạn thêm 20% nữa, nó sẽ thay đổi cuộc đời bạn. Cuộc sống sẽ trở nên có ý nghĩa hơn, thú vị hơn, và tất nhiên nó sẽ là bệ phóng giúp bạn đạt đến những đỉnh cao mà chẳng bao giờ bạn tưởng tượng đến – mà không cảm thấy áp lực chút nào. Nó có tác dụng như một “nguồn năng lượng ảo”, hiện hữu ngay đó, chỉ có điều bạn không nhận thấy mà thôi.
     
    Với PQ – Chỉ số đam mê, tác giả đã loại bỏ ảo tưởng rằng bằng cấp và chỉ số IQ cao mới là những động lực thúc đẩy để đạt được thành công. Chỉ số IQ giống như một đoạn mạch AND vững chắc rất khó cải thiện. Còn chỉ số PQ là chất lửa trong mỗi con người, chúng ta hoàn toàn có thể điều chỉnh ngọn lửa.
    `,
    Category: 'Kỹ năng',
    subCategory: 'Rèn luyện nhân cách'
...
{
    scrImg: 'Viêt lên hy vọng.jpg',
    name:'Viết lên hy vọng',
    price: 98000,
    amount: 1,
    NXB: 'NXB lao động',
    author: 'Erin Gruwell và Những Nhà văn Tự do',
    isSale: 22,
    page: 460,
    year: 2017,
    description: 'Viết Lên Hy Vọng. Trong vô vàn những câu danh ngôn về người thầy, có một câu nói rất nổi tiếng của nhà sư phạm Xô Viết, viện sĩ Viện Hàn lâm Khoa học Giáo dục Liên XôVasilij Aleksandrovich Sukhomlinskij rằng: "Đối với người giáo viên, cần phải có kiến thức, có hiểu biết sư phạm về quy luật xã hội, có khả năng dùng lời nói để tác động đến tâm hồn ...',
    subDescription: `Viết Lên Hy Vọng
...
{
    scrImg: 'Tâm lý học đám đông.jpg',
    ...
    page: 252,
    year: 2018,
    description: 'Kể từ khi xuất bản lần đầu tại Việt Nam, cuốn sách này đã được tái bản lại rất nhiều lần.. Tác giả Gustave Le Bon (1841 - 1931) là nhà tâm lí học xã hội nổi tiếng người Pháp với lí thuyết về đám đông. Ông viết về nhiều lĩnh vực và có ảnh hưởng rất lớn trong xã hội Pháp đương thời. Những tác phẩm nền tảng nhất của Le Bon là Quy luật tâm lí về ...',
    subDescription: `ể từ khi xuất bản lần đầu tại Việt Nam, cuốn sách này đã được tái bản lại rất nhiều lần.
...
{
    scrImg: 'chốt sale.jpg',
    name:'Chốt sale',
    price: 105000,
    amount: 1,
    NXB: 'NXB tổng hợp TP.HCM',
    author: 'Craig Christensen, Sean Frontz, Dennis Susa',
    isSale: 25,
    page: 128,
    year: 2019,
    description: '“Chốt Sales” chia sẻ những hiểu biết sâu sắc về nghề bán hàng với những kỹ năng & các bước quan trọng giúp mọi cá nhân có thể tiến hành việc chốt hợp đồng một cách hiệu quả nhất. Đơn giản mà nói, quyển sách này sẽ hướng dẫn chúng ta cách hoàn thành hợp đồng, tăng doanh số bán hàng đột phá bằng cách “giúp khách hàng ...',
    subDescription: `“Chốt Sales” chia sẻ những hiểu biết sâu sắc về nghề bán hàng với những kỹ năng & các bước quan trọng giúp mọi cá nhân có thể tiến hành việc chốt hợp đồng một cách hiệu quả nhất. Đơn giản mà nói, quyển sách này sẽ hướng dẫn chúng ta cách hoàn thành hợp đồng, tăng doanh số bán hàng đột phá bằng cách “giúp khách hàng thành công”.

    Phương pháp được giới thiệu trong cuốn sách này đã được kiểm chứng qua thời gian, dựa trên những nguyên lý căn cơ làm nên thành công của những lãnh đạo kinh doanh hàng đầu và các bậc thầy bán hàng trên toàn thế giới. Phương pháp độc đáo này đã được nhóm tác giả đúc kết và hệ thống lại thành một hình mẫu chung vừa chuyên sâu, vừa vô cùng thực tế, hữu dụng cho tất cả lãnh đạo lẫn các chuyên gia bán hàng. Khi mỗi cá nhân và các đội bán hàng kiên trì áp dụng cách tư duy cùng bộ kỹ năng được hướng dẫn trong quyển sách tuyệt vời này, họ sẽ cải thiện được đáng kể khả năng chốt hợp đồng của mình, một cách hiệu quả hơn, thường xuyên hơn, và có kết quả dự đoán trước chính xác hơn. 
...
{
    scrImg: 'Hiệu Ứng chim mồi.jpg',
    name:'Hiệu ứng chim mồi',
    price: 75000,
    amount: 1,
    NXB: 'NXT kinh tế TP.HCM',
    author: 'Ecoblader',
    isSale: 20,
    page: 130,
    year: 2016,
    description: 'Thông thường, khi mua hàng ở một số trang thương mại điện tử, ta thường rất khó phát hiện ô điền mã khuyến mãi trong quá trình mua hàng. Thậm chí, ở trang chuyên bán các sản phẩm tên miền, máy chủ Godaddy, nơi điền mã khuyến mãi được “ngụy trang” chỉ bằng dòng chữ “Have a promo code?” Tại sao Godaddy phải làm như vậy, khi mà họ luôn có các ...',
    subDescription: `Thông thường, khi mua hàng ở một số trang thương mại điện tử, ta thường rất khó phát hiện ô điền mã khuyến mãi trong quá trình mua hàng. Thậm chí, ở trang chuyên bán các sản phẩm tên miền, máy chủ Godaddy, nơi điền mã khuyến mãi được “ngụy trang” chỉ bằng dòng chữ “Have a promo code?” Tại sao Godaddy phải làm như vậy, khi mà họ luôn có các chương trình khuyến mãi hàng tuần?
...
{
    scrImg: 'Hãy Kinh Doanh Như starBuck.jpg',
    name:'Hãy kinh doanh như starbuck',
    price: 200000,
    amount: 1,
    NXB: 'NXB Lao Động Xã Hội',
    ...
    page: 392,
    year: 2019,
    description: 'Bạn có bao giờ không thể thức dậy nổi vào buổi sáng sớm để đi làm hay đi học mà không nhờ một tách cafe, bạn có bao giờ ngồi tán gẫu cả buổi tối ở một không gian yên tĩnh với người bạn của mình chưa? Cafe, trở thành một sự kết nối giữa những con người với nhau và thậm chí còn trở thành nét văn hóa riêng làm nên tiếng tăm cho những doanh nghiệp triệu ...',
    subDescription: `Bạn có bao giờ không thể thức dậy nổi vào buổi sáng sớm để đi làm hay đi học mà không nhờ một tách cafe, bạn có bao giờ ngồi tán gẫu cả buổi tối ở một không gian yên tĩnh với người bạn của mình chưa? Cafe, trở thành một sự kết nối giữa những con người với nhau và thậm chí còn trở thành nét văn hóa riêng làm nên tiếng tăm cho những doanh nghiệp triệu đô. Bạn có tự hỏi, tại sao có nhiều hãng cafe đến thế mà Starbucks vẫn đứng vững trên thương trường, điều gì làm nên sự khác biệt trong cách kinh doanh của ông chủ này?
    ...
    Không giống như cuốn sách trước đây của Joseph Michelli về nhà lãnh đạo cà phê, cuốn “Hãy kinh doanh như Starbucks” giúp bạn tận dụng những kết nối mà bạn xây dựng ở cấp độ cá nhân đồng thời mở rộng kết nối với khách hàng trên toàn cầu, thông qua công nghệ và thậm chí cả sản phẩm và hàng hóa của bạn. Ông cung cấp những hiểu biết thú vị về các nguyên tắc cơ bản liên quan đến việc tạo ra chuỗi cà phê lớn nhất thế giới. Là một người kinh doanh, bạn sẽ học được cách các nhà lãnh đạo Starbucks thúc đẩy thành công cũng như cách họ học hỏi từ những thất bại, đứng lên từ những sai lầm của mình
    
    Có 5 nguyên tắc để kết nối khách hàng, sản phẩm và thị trường mà Joseph Michelli đề cập tới và cũng là chủ đề chính của cuốn sách, đó là: Thưởng thức và hơn thế nữa; Yêu để được yêu; Vươn tới tầm cao chung; Huy động kết nối; Trân trọng và thách thức di sản trong bạn. Đọc những nguyên tắc này, thoạt đầu, bạn sẽ có cảm giác như đọc một cuốn sách viết về con người hơn là viết về kinh doanh. Đây chính là điểm khác biệt mà Starbucks đã vận dụng vào công việc kinh doanh của mình và thu hút khách hàng.
    
    Kinh doanh không chỉ đơn thuần là bán hàng mà còn là gieo niềm tin và sự thoải mái, lòng nhiệt huyết và sự kết nối. Tác giả đề cập đến tình yêu, tình yêu vào cafe đã làm cho con người gần nhau hơn, giúp cho công ty đứng vững trước những khó khăn thử thách. Tác giả coi trọng sự kết nối, bởi vì suy cho cùng chúng ta sống cùng nhau trên hành tinh này, đều là biểu hiện của những sự kết nối về mọi mặt. Cuốn sách “Hãy kinh doanh như Starbucks”, phác thảo các nguyên tắc nền tảng đã hướng dẫn các nhà lãnh đạo Starbucks trong các giai đoạn tăng trưởng liên tục với tốc độ chóng mặt, suy thoái kinh tế, phục hồi và chuyển đổi.
    
    Và chính chúng ta phải suy nghĩ, với một môi trường cạnh tranh khốc liệt như hiện nay, hàng ngày có hàng ngàn công ty được thành lập, tại sao một chuỗi cửa hàng cà phê nhỏ có trụ sở tại Seattle lại trở thành một trong những thương hiệu được yêu thích nhất trên hành tinh? Liệu những người đứng đầu có bí quyết gì chăng? Tất cả đều được tác giả gói gọn trong cuốn sách gối đầu giường này.
    
    “Hãy kinh doanh như Starbucks” xem xét các chiến lược và công cụ chính mà các nhà lãnh đạo đang triển khai để đạt được thành công bền vững, đặc biệt là trong các lĩnh vực tạo sản phẩm, tăng trưởng danh mục, mở rộng quốc tế và đổi mới công nghệ và truyền thông xã hội. Starbucks đã thu lợi bằng việc tạo ra sự khác biệt rõ rệt trong cộng đồng của họ và thu hút khách hàng thường xuyên. Tác giả đã chỉ ra rằng việc kinh doanh chỉ thực sự có lợi khi khách hàng cảm thấy thoải mái nhất. Khách hàng tin tưởng thì công ty mới có thể đứng vững được.
    
    Thực hiện theo các nguyên tắc này tạo ra sự kết nối mạnh mẽ với nhân viên, khách hàng, nhà cung cấp và thậm chí cả những người không quen thuộc. Đổi lại, những kết nối hoạt động và cảm xúc này sẽ giúp bất kỳ nhà lãnh đạo nào đạt được lợi nhuận bền vững, tăng giá trị thương hiệu và thúc đẩy những câu chuyện về lòng trung thành và tình yêu.
    
    Đồng thời, thông điệp xuyên suốt về một triết lí kinh doanh thành công chỉ đến từ con tim chân thành cũng khiến đây là một cuốn sách đáng đọc với những người làm dịch vụ nói chung. Vì vậy, bạn còn chờ đợi gì nữa? Mua sách, đào sâu và tìm kiếm các công cụ thiết thực và từ đó tự thân thay đổi! Hãy để cho chính mình được kết nối gần hơn với thế giới của những người thành công. Để bạn thấy rằng, kinh doanh là cả một quá trình mà nếu bạn học được những kinh nghiệm thành công từ người đi trước, tránh những sai lầm của họ, bạn đã thành công được một nửa rồi.
    `,
    Category: 'Kinh tế',
    subCategory: 'Nhân vật-Bài học kinh doanh'

},
{
    scrImg: 'Từ tốt đến vĩ đại.jpg',
    name:'Từ tối đến vĩ đại',
    price: 115000,
    amount: 10,
    NXB: 'NXB trẻ',
    author: 'Jim Collins',
    ...
    page: 448,
    year: 2017,
    description: 'Từ Tốt Đến Vĩ Đại. Jim Collins cùng nhóm nghiên cứu đã miệt mài nghiên cứu những công ty có bước nhảy vọt và bền vững để rút ra những kết luận sát sườn, những yếu tố cần kíp để đưa công ty từ tốt đến vĩ đại. Đó là những yếu tố khả năng lãnh đạo, con người, văn hóa, kỷ luật, công nghệ… Những yếu tố này được nhóm nghiên cứu xem xét tỉ mỉ ...',
    subDescription: `Từ Tốt Đến Vĩ Đại
...
{
    scrImg: 'Dốc hết trái tim.jpg',
    ...
    page: 488,
    year: 2018,
    description: 'Dốc Hết Trái Tim (Tái Bản 2018). Dốc hết trái tim là một quyển sách hay dành cho doanh nhân và mọi giám đốc hay lãnh đạo công ty. Tác giả đồng thời là người sáng lập của thương hiệu Starbucks, chia sẻ câu chuyện đầy cảm hứng về cuộc đời của ông từ khi còn đi học đến khi trở thành CEO của một thương hiệu nổi tiếng trên toàn thế giới. Độc giả sẽ tìm thấy ...',
    subDescription: `Dốc Hết Trái Tim (Tái Bản 2018)
...
{
    scrImg: 'Sự im lặng của bầy cừu.jpg',
    ...
    - Chicago Tribune`,
    Category: 'Văn học',
    subCategory: 'Tiêu thuyết'

},
{
    scrImg: 'Nhà giả kim.jpg',
    name:'Nhà giả kim',
    price: 69000,
    amount: 3,
    NXB: 'NXB Văn Học',
    ...
    page: 224,
    year: 2017,
    description: 'Nhà Giả Kim (Tái Bản 2017). NHÀ GIẢ KIM là cuốn sách được in nhiều nhất chỉ sau Kinh Thánh. Cuốn sách của Paulo Coelho có sự hấp dẫn ra sao khiến độc giả không chỉ các xứ dùng ngôn ngữ Bồ Đào Nha mà các ngôn ngữ khác say mê như vậy?. Tiểu thuyết NHÀ GIẢ KIM của Paulo Coelho như một câu chuyện cổ tích giản dị, nhân ái, giàu chất ...',
    subDescription:`Nhà Giả Kim (Tái Bản 2017)
...
{
    scrImg: 'Kính sợ và run rẩy.jpg',
    name:'Kính sợ và run rẩy',
    price: 169000,
    amount: 1,
    NXB: 'NXB Hồng Đức',
    ...
    page: 303,
    year: 2019,
    description: 'Từ câu chuyện trong Kinh Thánh Cựu Ước mô tả việc Tổ phụ Abraham tuân lệnh Thiên Chúa, sẵn sàng sát tế con trai mình là Isaac (thường được ngợi ca như một điển tích về sự trung thành vô điều kiện), triết gia Soren Kierkegaard triển khai ba luận đề truy vấn: liệu có tồn tại một sự đình bỏ có tính mục đích luận đối với luân lý hay không?; liệu có tồn tại một bổn ...',
    subDescription: `Từ câu chuyện trong Kinh Thánh Cựu Ước mô tả việc Tổ phụ Abraham tuân lệnh Thiên Chúa, sẵn sàng sát tế con trai mình là Isaac (thường được ngợi ca như một điển tích về sự trung thành vô điều kiện), triết gia Soren Kierkegaard triển khai ba luận đề truy vấn: liệu có tồn tại một sự đình bỏ có tính mục đích luận đối với luân lý hay không?; liệu có tồn tại một bổn phận tuyệt đối với Thượng đế hay không?; Liệu Abraham có thể biện hộ được về mặt luân lý khi che giấu mục đích của mình không cho Sarah, Eleazar và Isaac biết hay không?
...
{
    scrImg: 'Người thắp sao trời.jpg',
    ...
    Category: 'Văn học',
    subCategory: 'Ngôn tình'

},
{
    scrImg: 'Nụ hôn của sói.jpg',
    name:'Nụ hôn của sói',
    price: 119000,
    amount: 1,
    NXB: 'NXB Văn Học',
...
{
    scrImg: 'Ngủ ngon hẹn mai nhé.jpg',
    name:'Ngủ ngon hẹn mai nhé',
    price: 80000,
    amount: 1,
    NXB: 'IPM',
    author: 'Nagira Yu',
    ...
    page: 380,
    year: 2016,
    description: 'Ngủ Ngon, Hẹn Mai Nhé Profile. Nagira Yu. Sinh ngày 25 tháng Một, cung Bảo Bình, nhóm máu A. Chúc mọi người năm mới vui vẻ. Hy vọng năm nay mọi người cũng gặp được nhiều điều đáng yêu.. Cover Art. Họa sĩ/Oyamada Ami. Sinh ngày 01 tháng Năm, cung Bạch Dương, nhóm máu O. Họa sĩ truyện tranh, họa sĩ minh họa. Tác phẩm tiêu biểu Theo đuổi ký ức (Libre xuất bản).  . Hạnh phúc đột ...',
    subDescription: `Ngủ Ngon, Hẹn Mai Nhé
    Profile
